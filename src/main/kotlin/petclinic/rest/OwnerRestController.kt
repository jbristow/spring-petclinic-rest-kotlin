...
open class OwnerRestController(val clinicService: ClinicService) {
    ...
    fun getOwner(@PathVariable("ownerId") ownerId: Int): ResponseEntity<Owner> {
        println("ownerID: $ownerId, CLINICSERVICE: $clinicService")
    ...
    fun updateOwner(
        ...
        val currentOwner = clinicService.findOwnerById(ownerId)?.apply {

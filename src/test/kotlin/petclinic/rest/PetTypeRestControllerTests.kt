...
class PetTypeRestControllerTests {
    ...
    fun testGetPetTypeSuccess() {
        given<PetType>(clinicService.findPetTypeById(1)).willReturn(cat)
        mockMvc.perform(
            get("/api/pettypes/1")
    ...
    fun testGetPetTypeNotFound() {
        given<PetType>(clinicService.findPetTypeById(-1)).willReturn(null)
        mockMvc.perform(
            get("/api/pettypes/-1")
    ...
    fun testGetAllPetTypesSuccess() {
        given(clinicService.findAllPetTypes()).willReturn(listOf(dog, snake))
        mockMvc.perform(
            get("/api/pettypes/")
                .accept(MediaType.APPLICATION_JSON)
        )
    ...
    fun testGetAllPetTypesNotFound() {
        given(clinicService.findAllPetTypes()).willReturn(emptyList())
        mockMvc.perform(
            get("/api/pettypes/")
                .accept(MediaType.APPLICATION_JSON)
        )
    ...
    fun testUpdatePetTypeSuccess() {
        given<PetType>(clinicService.findPetTypeById(2)).willReturn(dog)
